...
public class AbstractTest {
	...
	protected synchronized WebDriver getBrowserDriverAutoUrl(String browserName, String url) {
		if (browserName.equalsIgnoreCase("firefox_ui")) {
			...
			System.setProperty(FirefoxDriver.SystemProperty.BROWSER_LOGFILE, rootFolder + "\\target\\Firefox Logs.txt");
			...
			System.setProperty("webdriver.chrome.driver", rootFolder + "\\scr\\main\\resources\\chromedriver_v80_brave.exe");
	...
	public void deleteAllFilesInFolder() {
		try {
			...
			String screenshotFolderPath = rootFolder + "\\target\\screenshotReportNG";
