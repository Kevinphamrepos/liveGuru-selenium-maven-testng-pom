...
public class ReportNGListener extends AbstractTest implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		Reporter.log("<br><a target=\"_blank\" href=\"file:///" + screenshotPath + "\">" + "<img src=\"file:///" + screenshotPath + "\" " + "height='100' width='150'/> " + "</a></br>"); // Insert link chứa screenshot vào trong file report HTML
	...
	public String captureScreenshot(WebDriver driver, String screenshotName) {
		try {
			...
			String screenPath = System.getProperty("user.dir") + "\\target\\screenshotReportNG\\" + screenshotName + "_" + formater.format(calendar.getTime()) + ".png";
